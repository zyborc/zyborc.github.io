import{c as p}from"./index-k4mD6t8B.js";const d=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 6v6l4 2",key:"mmk7yg"}]],C=p("clock",d),u=`---
...
`,w=Object.assign({"../content/blog/2023-09-displaying-sharepoint-version-history-in-power-apps.md":u,"../content/blog/2026-03-copilot-studio-dynamic-adaptive-cards.md":h,"../content/blog/2026-03-power-apps-code-apps-claude-skill.md":m,"../content/blog/2026-03-power-apps-code-apps-getting-started.md":f,"../content/blog/2026-03-power-apps-code-apps-lessons-learned.md":g,"../content/blog/2026-03-power-apps-copilot-studio-pitfalls.md":y}),v=t=>{const e=t.trim().split(/\s+/).filter(Boolean).length;return Math.max(1,Math.ceil(e/200))},b=t=>typeof t!="string"?new Date().toISOString().slice(0,10):t,c=t=>{const e=t.trim();return e==="true"?!0:e==="false"?!1:e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'")?e.slice(1,-1):e},k=t=>{const e=t.trim().replace(/^\[/,"").replace(/\]$/,"");return e?e.split(",").map(o=>c(o)).filter(o=>typeof o=="string"&&o.length>0):[]},T=t=>{if(!t.startsWith("---"))return{data:{},content:t.trim()};const e=t.match(/^---\r?\n([\s\S]*?)\r?\n---\r?\n?([\s\S]*)$/);if(!e)return{data:{},content:t.trim()};const[,o,r]=e,i={};for(const n of o.split(/\r?\n/)){if(!n.trim())continue;const s=n.indexOf(":");if(s===-1)continue;const l=n.slice(0,s).trim(),a=n.slice(s+1).trim();i[l]=a.startsWith("[")?k(a):c(a)}return{data:i,content:r.trim()}},A=()=>Object.entries(w).map(([t,e])=>{const o=t.split("/").pop()?.replace(/\.md$/,"")??"post",i=T(typeof e=="string"?e:""),n=i.data;return{slug:o,title:n.title??o,date:b(n.date),tags:Array.isArray(n.tags)?n.tags:[],summary:n.summary??"",coverImage:n.coverImage,draft:n.draft??!1,content:i.content.trim(),readingTimeMinutes:v(i.content)}}).filter(t=>!t.draft).sort((t,e)=>e.date.localeCompare(t.date)),I=t=>A().find(e=>e.slug===t);export{C,I as a,A as g};
